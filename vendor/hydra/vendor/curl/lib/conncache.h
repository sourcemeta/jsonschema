...
int Curl_cpool_init(struct cpool *cpool,
                    Curl_cpool_disconnect_cb *disconnect_cb,
                    struct Curl_multi *multi, struct Curl_share *share,
                    size_t size);
...
int Curl_cpool_check_limits(struct Curl_easy *data, struct connectdata *conn);

/* Return of conn is suitable. If so, stops iteration. */
typedef bool Curl_cpool_conn_match_cb(struct connectdata *conn, void *userdata);
 ...
 */
bool Curl_cpool_find(struct Curl_easy *data, const char *destination,
                     size_t dest_len, Curl_cpool_conn_match_cb *conn_cb,
 ...
 */
bool Curl_cpool_conn_now_idle(struct Curl_easy *data, struct connectdata *conn);
 ...
 */
void Curl_cpool_disconnect(struct Curl_easy *data, struct connectdata *conn,
                           bool aborted);
...
typedef void Curl_cpool_conn_do_cb(struct connectdata *conn,
                                   struct Curl_easy *data, void *cbdata);
 ...
 * pool associated.
 */
void Curl_cpool_do_locked(struct Curl_easy *data, struct connectdata *conn,
                          Curl_cpool_conn_do_cb *cb, void *cbdata);
...
void Curl_cpool_multi_socket(struct Curl_multi *multi, curl_socket_t s,
                             int ev_bitmask);
