...
bool Curl_on_disconnect(struct Curl_easy *data, struct connectdata *,
                        bool aborted);
 ...
 */
bool Curl_conn_seems_dead(struct connectdata *conn, struct Curl_easy *data,
                          struct curltime *nowp);

/**
 * Perform upkeep operations on the connection.
 */
CURLcode Curl_conn_upkeep(struct Curl_easy *data, struct connectdata *conn,
                          struct curltime *now);
