...
struct Curl_cwtype {
  ...
  CURLcode (*do_init)(struct Curl_easy *data, struct Curl_cwriter *writer);
  CURLcode (*do_write)(struct Curl_easy *data, struct Curl_cwriter *writer,
                       int type, const char *buf, size_t nbytes);
  void (*do_close)(struct Curl_easy *data, struct Curl_cwriter *writer);
 ...
 */
void Curl_cwriter_free(struct Curl_easy *data, struct Curl_cwriter *writer);
 ...
 */
CURLcode Curl_cwriter_add(struct Curl_easy *data, struct Curl_cwriter *writer);
...
void Curl_cwriter_remove_by_name(struct Curl_easy *data, const char *name);
 ...
 */
CURLcode Curl_cwriter_write(struct Curl_easy *data, struct Curl_cwriter *writer,
                            int type, const char *buf, size_t nbytes);
...
struct Curl_crtype {
  ...
  CURLcode (*resume_from)(struct Curl_easy *data, struct Curl_creader *reader,
                          curl_off_t offset);
  ...
  void (*done)(struct Curl_easy *data, struct Curl_creader *reader,
               int premature);
...
bool Curl_creader_def_is_paused(struct Curl_easy *data,
                                struct Curl_creader *reader);
void Curl_creader_def_done(struct Curl_easy *data, struct Curl_creader *reader,
                           int premature);
 ...
 */
CURLcode Curl_creader_read(struct Curl_easy *data, struct Curl_creader *reader,
                           char *buf, size_t blen, size_t *nread, bool *eos);
 ...
 */
CURLcode Curl_creader_add(struct Curl_easy *data, struct Curl_creader *reader);
 ...
 */
CURLcode Curl_creader_set_buf(struct Curl_easy *data, const char *buf,
                              size_t blen);
