...
#define CURL_IGNORE_DEPRECATION(statements) \
  _Pragma("diag_suppress=Pe1444") statements _Pragma("diag_default=Pe1444")
#else
#define CURL_IGNORE_DEPRECATION(statements)                           \
...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
    ...
    defined(__minix) || defined(__INTEGRITY) || defined(ANDROID) ||         \
    defined(__ANDROID__) || defined(__OpenBSD__) || defined(__CYGWIN__) ||  \
    defined(AMIGA) || defined(__NuttX__) ||                                 \
...
#define CURL_EXTERN
#elif defined(_WIN32) || (__has_declspec_attribute(dllexport) && \
