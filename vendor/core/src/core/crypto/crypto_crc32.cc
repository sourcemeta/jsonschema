...
// The slice-by-8 tables for the reflected CRC-32 polynomial 0xEDB88320, where
// the first is the classic byte-at-a-time table and every other one follows
// as T[k][b] = (T[k-1][b] >> 8) ^ T[0][T[k-1][b] & 0xff]
