...
sourcemeta::core::SchemaVocabularies::SchemaVocabularies(
...
auto sourcemeta::core::SchemaVocabularies::contains(
...
auto sourcemeta::core::SchemaVocabularies::contains_any(
...
// NOLINTNEXTLINE(bugprone-exception-escape)
auto sourcemeta::core::SchemaVocabularies::insert(
...
auto sourcemeta::core::SchemaVocabularies::insert(Known vocabulary,
...
// NOLINTNEXTLINE(bugprone-exception-escape)
auto sourcemeta::core::SchemaVocabularies::get(
...
auto sourcemeta::core::SchemaVocabularies::get(Known vocabulary) const noexcept
    -> std::optional<bool> {
  const auto index = std::to_underlying(vocabulary);
  // Use [] operator instead of test() to avoid exceptions in noexcept function
...
auto sourcemeta::core::SchemaVocabularies::size() const noexcept
    -> std::size_t {
  return (this->required_known_ | this->optional_known_).count() +
         (this->unknown_.has_value() ? this->unknown_->size() : 0);
}

auto sourcemeta::core::SchemaVocabularies::empty() const noexcept -> bool {
...
auto sourcemeta::core::vocabulary_uri(SchemaVocabularies::Known vocabulary)
    -> std::string_view {
  switch (vocabulary) {
// NOLINTNEXTLINE(bugprone-macro-parentheses)
...
auto sourcemeta::core::vocabulary_uri(const SchemaVocabularies::URI &vocabulary)
    -> std::string_view {
...
auto sourcemeta::core::SchemaVocabularies::throw_if_any_unsupported(
