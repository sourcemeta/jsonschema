...
HASH_ALPHA="$(shasum -a 256 < "$TMP/project/vendor/alpha.json" | cut -d ' ' -f 1)"
HASH_BETA="$(shasum -a 256 < "$TMP/project/vendor/beta.json" | cut -d ' ' -f 1)"
